...
const popularProducts = [
  { name: 'Asgaard Sofa', value: 400, color: '#0088FE' },
  { name: 'Outdoor Set', value: 300, color: '#00C49F' },
  { name: 'Dining Table', value: 300, color: '#FFBB28' },
  { name: 'Study Desk', value: 200, color: '#FF8042' },
];
    ...
    <div className="container mx-auto p-6">
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        ...
        <TabsContent value="overview" className="space-y-4">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Sales & Traffic Overview</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          {/* Popular Products & Traffic Source */}
